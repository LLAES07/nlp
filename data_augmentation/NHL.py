...
def variar_frase(nhl, num, abrev_corte, cortes_chile, pidase_formas, partes_formas, planes):
...
def genera_frase_aleatorea():
    ...
    return variar_frase(nhl_sel, num, abrevia_corte_sel, corte_sel, pidase_sel, partes_sel, planes_sel)
